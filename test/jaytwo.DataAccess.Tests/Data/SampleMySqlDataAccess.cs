...
public class SampleMySqlDataAccess : MySqlDataAccessBase, IMySqlDataAccess, ISampleDataAccess
{
    public SampleMySqlDataAccess(string defaultConnectionString, ITracer? tracer = null)
