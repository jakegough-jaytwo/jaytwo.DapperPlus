...
public class DapperWrapperTests
{
    ...
    public void CreateConnection()
    {
        ...
        var dapperWrapper = new DapperWrapper(() => connection, default);
    ...
    public async Task ExecuteAsync(CommandType commandType)
    {
        ...
        Expression<Func<DapperWrapper, Task<int>>> testExpression =
            x => x.ExecuteAsync(
        ...
        var dapperWrapper = new Mock<DapperWrapper>(connectionFactory) { CallBase = true };
        dapperWrapper
    ...
    public async Task ExecuteScalarAsync(CommandType commandType)
    {
        ...
        Expression<Func<DapperWrapper, Task<string?>>> testExpression =
    ...
    public async Task QuerySingleAsync(CommandType commandType)
    {
        ...
        Expression<Func<DapperWrapper, Task<MyRecord>>> testExpression =
    ...
    public async Task QueryAsync(CommandType commandType)
    {
        ...
        Expression<Func<DapperWrapper, Task<IList<MyRecord>>>> testExpression =
    ...
    public async Task QueryMultipleAsync(CommandType commandType)
    {
        ...
        Expression<Func<DapperWrapper, Task<IGridReaderWrapper>>> testExpression =
    ...
    public void QueryUnbufferedAsync(CommandType commandType)
    {
        ...
        Expression<Func<DapperWrapper, IAsyncEnumerable<MyRecord>>> testExpression =
    ...
    public async Task QueryUnbufferedAsync_cancellationToken_is_preserved()
    {
        ...
        var dapperWrapper = new DapperWrapper(connectionFactory);
